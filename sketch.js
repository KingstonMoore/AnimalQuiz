...
function preload(){
  ...
  failed = loadSound("failed.mp3")
  congrats = loadSoung("congrats.mp3")
}
...
function question4(){
  ...
  background(q4Img)
  q4 = createElement('h1')
  q4.html("Question 3: Which of these animals can run the fastest?")
  q4.style("background-color", "white")
  q4.position(300, 150)

  q4a1 = createButton("A Cheetah")
  ...
  q4a1.mousePressed(q4op1)

  q4a2 = createButton("A Kangaroo")
  ...
  q4a2.mousePressed(q4op2)

  q4a3 = createButton("A Wolf")
  ...
  q4a3.mousePressed(q4op3)

  q4a4 = createButton("A Human")
